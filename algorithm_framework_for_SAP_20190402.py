...
print "MIP Solvers and the default solver:",mip_solvers, mip_solver
...
total_pop=0
avg_dis_min=0.0
spatial_contiguity=0 # 0 no, 1 yes
...
##            initial_solution(multi_start)
    ...
    while 1:
        ...
        print [b1,b2,len(population)], [diff1,diff2],
        print "gen", loop,idx1,idx2,
        ...
        population.append([biobjective,centersID[:],node_groups[:]])
        print int(diffunits),diffunits2,
...
#        if is_spp_modeling==1 and loop%spp_loops==spp_loops-1:
        ...
        while len(population)>multi_start_count*2:
            population.pop()
        print not_improved,int((time.time()-t_ga)*100)/100.0
